...
const TOAST = {
   ...
   */
  show: (message: string, type: number = 1, needTime = false, duration: number = 2000, maskClickable: boolean = true, className: string = '', onAfterClose?: Function) => {
